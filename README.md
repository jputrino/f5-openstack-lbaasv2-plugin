...
## Compatibility
This plugin can be used with OpenStack releases from Liberty forward. If you are using an earlier release -- aside from considering an upgrade -- you'll have to use the [LBaaSv1 plugin](https://github.com/F5Networks/f5-openstack-lbaasv1). 
